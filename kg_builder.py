...
class KGBuilder:
    ...
    def vector_entity_retrieve(self, query: str, k: int = 20) -> List[Dict]:
        """
        向量实体检索: 使用嵌入向量查找相似实体
    ...
    def vector_relation_retrieve(self, query: str, k: int = 20) -> List[Dict]:
        """
        向量关系检索: 使用嵌入向量查找相似关系
    ...
    def remove_data_by_chunk_ids(self, chunk_ids: List[int]):
        """
        从Neo4j数据库中删除指定chunk_ids的数据
