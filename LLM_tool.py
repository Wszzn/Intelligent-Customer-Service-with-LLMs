...
class LLMHandler:
    def __init__(self):
        ...
        # self.client = OpenAI(api_key="sk-hjexxiqvkahyxeznmxskiqhwxvjanwdsfodxrtuvcntzqjio", base_url="https://api.siliconflow.cn")
    ...
    def mix_rag_response(self, query, vector_context, kg_context):
        ...
        try:
            ...
            print("无法直接解析响应为JSON，返回空结果")
            return {"question": "", "keyword": "", "answer": ""}
